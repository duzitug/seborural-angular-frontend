...
$routes->scope('/api/v1', function (RouteBuilder $routes) {
    ...
    $routes->resources('Books', [
        'map' => [
            'getBooksByCourseId' => [
                'action' => 'getBooksByCourseId',
                'method' => 'GET',
                'path' => '/getBooksByCourseId/:id'
            ],
        ]
    ]);
    ...
    $routes->resources('Books', [
        'map' => [
            'getBooksByGenreId' => [
                'action' => 'getBooksByGenreId',
                'method' => 'GET',
                'path' => '/getBooksByGenreId/:id'
            ],
        ]
    ]);
    ...
    $routes->resources('Courses', [
        'map' => [
            'getBooksByCourseName' => [
                'action' => 'getBooksByCourseName',
                'method' => 'GET',
                'path' => '/getBooksByCourseName/:name'
            ],
        ]
    ]);
